...
export async function main(
  ...
  // Fetch the bot user ID to construct the git committer info
  const userResponse = await request("GET /users/{username}", {
  ...
  core.setOutput("git-committer-name", `${appSlug}[bot]`);
  core.setOutput(
    "git-committer-email",
    `${botUserId}+${appSlug}[bot]@users.noreply.github.com`,
  );
