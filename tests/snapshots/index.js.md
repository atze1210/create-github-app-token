...
> stdout
    ...
    ␊
    ::set-output name=git-committer-name::github-actions[bot]␊
    ␊
    ::set-output name=git-committer-email::123456789+github-actions[bot]@users.noreply.github.com␊
    ...
    GET /api/v3/users/github-actions%5Bbot%5D`
...
> stdout
    ...
    {"repositories":["create-github-app-token"]}␊
    GET /users/github-actions%5Bbot%5D`
